<section class="ftco-section img" id="ftco-testimony" style="background-image: url({{ asset('client/images/bg_1.jpg') }}"
        ...
        <div class="row d-flex no-gutters">
                ...
                <div class="testimony">
                    ...
                    <div class="author d-flex mt-4">
                        <div class="image mr-3 align-self-center">
                            <img src="{{ asset('client/images/person_1.jpg') }}" alt="">
                        </div>
            ...
            <div class="col-lg align-self-sm-end">
                <div class="testimony overlay">
                    ...
                    <div class="author d-flex mt-4">
                        <div class="image mr-3 align-self-center">
                            <img src="{{ asset('client/images/person_2.jpg') }}" alt="">
                        </div>
                        <div class="name align-self-center">Louise Kelly <span class="position">Illustrator
                                Designer</span></div>
                    </div>
            ...
            <div class="col-lg align-self-sm-end ftco-animate">
                <div class="testimony">
                    ...
                    <div class="author d-flex mt-4">
                        <div class="image mr-3 align-self-center">
                            <img src="{{ asset('client/images/person_3.jpg') }}" alt="">
                        </div>
                        <div class="name align-self-center">Louise Kelly <span class="position">Illustrator
                                Designer</span></div>
                    </div>
